<div>
    ...
    <form class="search-wrapper" action="">
        ...
        @if(!empty(request()->query()))
            <a style="text-decoration: none;" href="{{route('real-estates.index')}}" class="search-item-wrapper">
...
<section class="listing-section">
    ...
    @foreach($filteredlistings as $listing)
        ...
        <a style="all: unset;cursor:pointer" href="{{route('real-estates.show',['id'=>$listing['id']])}}">
