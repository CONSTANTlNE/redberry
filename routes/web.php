...
route::post('create/real-estates',[RealEstatesController::class,'create'])->name('real-estates.create');
route::post('real-estates',[RealEstatesController::class,'store'])->name('real-estates.create');
